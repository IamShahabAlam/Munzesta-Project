...
class OTPCodeCard extends StatelessWidget {
  ...
  OTPCodeCard({this.btnText,this.details,this.path,this.title, this.onpressed,  this.controller,});
  
  final String title, path, details, btnText; 
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(left:25, right: 25, top: MediaQuery.of(context).size.height*0.20),
    ...
    Column(
      children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          //   height: 35, width: 240,
    Container( height: MediaQuery.of(context).size.height*0.08, width: MediaQuery.of(context).size.width*0.72,
