...
class AfterVerify extends StatelessWidget {
  @override
            ...
            Column( 
              ...
              children: [
                Container(
                  ...
                  image: AssetImage("assets/illusReg.png") )),),
                  ...
                  Padding(
                      ...
                      Container( margin: EdgeInsets.only(left:20, right: 20 , top :10),
                        child: 
                        Text("You have successfully registered in our App. This is app is entirely Built on Flutter with the integration of FireBase.",style: TextStyle(height: 1.5 ,fontSize: 16,  color: Colors.grey[700]),
                        )),
